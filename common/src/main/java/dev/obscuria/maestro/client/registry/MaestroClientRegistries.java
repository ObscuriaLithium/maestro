...
public interface MaestroClientRegistries {
    ...
    DelegatedRegistry<MapCodec<? extends MusicCondition>> MUSIC_CONDITION = REGISTRAR.createRegistry(Key.MUSIC_CONDITION);
    ...
    interface Key {
        ...
        ResourceKey<Registry<MapCodec<? extends MusicCondition>>> MUSIC_CONDITION = create("music_condition");
